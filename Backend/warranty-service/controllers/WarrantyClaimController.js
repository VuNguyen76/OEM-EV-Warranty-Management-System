...
class WarrantyClaimController {
    ...
    static async createClaim(req, res) {
        try {
            const createDto = new CreateWarrantyClaimDto(req.body);
            ...
            const vinValidation = await VehicleServiceClient.validateVIN(createDto.vin);
            ...
            const claim = new WarrantyClaim(createDto.toModel());
            await claim.save();
